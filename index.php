...
<main>
  <div class="jumbotron">
<h2>Bienvenido a ComercioRural</h2>
<p>La primera aplicacion web 100% exclusiva para fruta y verdura.
Aqui podra comprar o vender sus productos. Si usted tiene dudas puede consultar en</p> <a href="ayuda" class="btn btn-info">Ayuda</a>
</div>
<?php
...
echo '<ul class="nav nav-tabs nav-fill">
  <li class="nav-item">
  <a class="nav-link active navbonita" data-toggle="tab" href="#productor">Productos</a>
  </li>
  <li class="nav-item">
  <a class="nav-link navbonita" data-toggle="tab" href="#comerciante">Pedidos</a>
  </li>
</ul>';
}else{
echo '<ul class="nav nav-tabs nav-fill">
  <li class="nav-item">
  <a class="nav-link active navbonita" data-toggle="tab" href="#comerciante">Pedidos</a>
  </li>
  <li class="nav-item">
  <a class="nav-link navbonita" data-toggle="tab" href="#productor">Productos</a>
  </li>
</ul>';
}
...
<div class="col-md-4">
  ...
  <figcaption class="info-wrap">
    <h4 class="title"><?php echo $fila[7];?></h4>
    <h6 class="desc"><?php for ($i=0;$i<$lencategorias;$i++){echo $categorias[$i]." Cantidad: ".$cantidad[$i]."<br>";} ?></h6>
